        ...
        <div className="smp-page">
            <div className="smp-topbar">
                ...
                <span className="smp-topbar-icon" style={{ display: "flex", alignItems: "center" }}>
                    <img src={clockIcon} alt="Timetable" style={{ width: 28, height: 28, objectFit: "contain" }} />
                </span>
            </div>
            <div className="smp-content">
                <div className="smp-empty">
                    <img src={clockIcon} alt="Timetable" style={{ width: 64, height: 64, objectFit: "contain", marginBottom: 12 }} />
